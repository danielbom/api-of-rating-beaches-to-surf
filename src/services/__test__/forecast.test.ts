...
describe('Forecast Service', () => {
  ...
  it('should return the forecast for multiple beaches in the same hour with different ratings orderer by rating', async () => {
    stormGlassClient.fetchPoints.mockResolvedValueOnce([
      {
    ...
    expect(stormGlassClient.fetchPoints).toBeCalledTimes(2);
